      ...
      <div class="border-b border-gray-900/10 pb-12">
        ...
        <div class="overflow-hidden max-w-xl rounded-lg bg-white shadow">
          <div class="px-4 py-5 sm:p-2">
            <ul class="px-2">
              <li>
                <NuxtLink :to="submission.datatrackerUrl"
...
const state = reactive({
  deadline: DateTime.now().plus({ weeks: 6 }).toISODate(),
  labels: []
})
...
const submission = computed(() => ({
  ...
  submittedFormat: 'v2',
  datatrackerUrl: `http://localhost:8000/doc/${route.query.draft}/`
}))
